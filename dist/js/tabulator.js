...
;(function (global, factory) {
	...
	Edit.prototype.editors = {
		...
		remoteAutocomplete: function remoteAutocomplete(cell, onRendered, success, cancel, editorParams) {
			var self = this,
			    cellEl = cell.getElement(),
			    initialValue = cell.getValue(),
			    input = document.createElement("input"),
			...
			var getValues = debounce(function () {
				console.log('keyup');

				var url = editorParams.url;
		...
		if (field) {
			...
			if (editor) {
				...
				if (column.definition.headerFilterLiveFilter !== false) {
					...
					if (!((column.definition.headerFilter === 'autocomplete' || column.definition.headerFilter === 'remoteAutocomplete' || column.definition.editor === 'autocomplete' || column.definition.headerFilter === 'tickCross' || column.definition.editor === 'tickCross') && column.definition.headerFilter === true)) {
	...
	Page.prototype._getRemotePage = function () {
		...
		return new Promise(function (resolve, reject) {
			...
			self.table.modules.ajax.sendRequest(_this43.progressiveLoad && self.page !== 1).then(function (data) {
